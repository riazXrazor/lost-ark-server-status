...
running command...
$ lass (--version)
lost-ark-server-status/0.0.0 win32-x64 node-v16.14.0
$ lass --help [COMMAND]
USAGE
  $ lass COMMAND
...
...
# Commands
<!-- commands -->
* [`lass hello PERSON`](#lass-hello-person)
* [`lass hello world`](#lass-hello-world)
...
_See code: [dist/commands/hello/index.ts](https://github.com/riazXrazor/lost-ark-server-status/blob/v0.0.0/dist/commands/hello/index.ts)_
